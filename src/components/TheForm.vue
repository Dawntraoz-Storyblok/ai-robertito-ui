<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-4xl mx-auto py-6 md:py-10">
      ...
      <div class="text-center md:text-start">
        ...
        <input id="question" type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs"
          v-model="question" />
        <button class="btn btn-ghost btn-circle -translate-x-12 translate-y-1">
  ...
  <Markdown v-if="results" :source="results" class="w-full max-w-4xl mx-auto rounded-xl bg-primary-focus text-white p-8 prose" />
</template>
